...
class Queue
{
 public:
  ...
  /*-----------------------------------------------------------------------
    ...
    Precondition:  None.
    Postcondition: An empty Queue object has been constructed; myFront and myBack are initialized to -1
        and myArray is an array with
 ...
 private:
  /***** Data Members *****/
   int myFront,
       myBack;
   QueueElement myArray[QUEUE_CAPACITY] = {0};
