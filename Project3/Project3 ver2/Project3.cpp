...
int main()
{
    ...
    double sTime1 = (double)(clock() - startClicks) * 1000 / CLOCKS_PER_SEC;
    ...
    double iTime1 = (double)(clock() - startClicks) * 1000 / CLOCKS_PER_SEC;
    ...
    double rTime1 = (double)(clock() - startClicks) * 1000 / CLOCKS_PER_SEC;
    ...
    double hTime1 = (double)(clock() - startClicks) * 1000 / CLOCKS_PER_SEC;
    ...
    double qTime1 = (double)(clock() - startClicks) * 1000 / CLOCKS_PER_SEC;
    ...
    double mQTime1 = (double)(clock() - startClicks) * 1000 / CLOCKS_PER_SEC;
    ...
    startClicks = clock();              // mark the start time clicks
    selectionSort(arrTemp, SIZE);       // sort arrTemp by Selection Sort
    double sTime2 = (double)(clock() - startClicks) * 1000 / CLOCKS_PER_SEC;
    ...
    startClicks = clock();              // mark the start time clicks
    insertionSort(arrTemp, SIZE);       // sort arrTemp by Insertion Sort
    double iTime2 = (double)(clock() - startClicks) * 1000 / CLOCKS_PER_SEC;
    ...
    startClicks = clock();              // mark the start time clicks
    radixSort(arrTemp, SIZE);           // sort arrTemp by Radix Sort
    double rTime2 = (double)(clock() - startClicks) * 1000 / CLOCKS_PER_SEC;
    ...
    double hTime2 = (double)(clock() - startClicks) * 1000 / CLOCKS_PER_SEC;
    ...
    startClicks = clock();              // mark the start time clicks
    quicksort(arrTemp, 0, SIZE);        // sort arrTemp by Quick Sort
    double qTime2 = (double)(clock() - startClicks) * 1000 / CLOCKS_PER_SEC;
    ...
    startClicks = clock();               // mark the start time clicks
    modifiedQuickSort(arrTemp, 0, SIZE); // sort arrTemp by Quick Sort
    double mQTime2 = (double)(clock() - startClicks) * 1000 / CLOCKS_PER_SEC;
    ...
    startClicks = clock();              // mark the start time clicks
    selectionSort(arrTemp, SIZE);       // sort arrTemp by Selection Sort
    double sTime3 = (double)(clock() - startClicks) * 1000 / CLOCKS_PER_SEC;
    ...
    startClicks = clock();              // mark the start time clicks
    insertionSort(arrTemp, SIZE);       // sort arrTemp by Insertion Sort
    double iTime3 = (double)(clock() - startClicks) * 1000 / CLOCKS_PER_SEC;
    ...
    startClicks = clock();              // mark the start time clicks
    radixSort(arrTemp, SIZE);           // sort arrTemp by Radix Sort
    double rTime3 = (double)(clock() - startClicks) * 1000 / CLOCKS_PER_SEC;
    ...
    double hTime3 = (double)(clock() - startClicks) * 1000 / CLOCKS_PER_SEC;
    ...
    startClicks = clock();              // mark the start time clicks
    quicksort(arrTemp, 0, SIZE);        // sort arrTemp by Quick Sort
    double qTime3 = (double)(clock() - startClicks) * 1000 / CLOCKS_PER_SEC;
    ...
    startClicks = clock();               // mark the start time clicks
    modifiedQuickSort(arrTemp, 0, SIZE); // sort arrTemp by Quick Sort
    double mQTime3 = (double)(clock() - startClicks) * 1000 / CLOCKS_PER_SEC;
    ...
    startClicks = clock();              // mark the start time clicks
    selectionSort(arrTemp, SIZE);       // sort arrTemp by Selection Sort
    double sTime4 = (double)(clock() - startClicks) * 1000 / CLOCKS_PER_SEC;
    ...
    startClicks = clock();              // mark the start time clicks
    insertionSort(arrTemp, SIZE);       // sort arrTemp by Insertion Sort
    double iTime4 = (double)(clock() - startClicks) * 1000 / CLOCKS_PER_SEC;
    ...
    startClicks = clock();              // mark the start time clicks
    radixSort(arrTemp, SIZE);           // sort arrTemp by Radix Sort
    double rTime4 = (double)(clock() - startClicks) * 1000 / CLOCKS_PER_SEC;
    ...
    double hTime4 = (double)(clock() - startClicks) * 1000 / CLOCKS_PER_SEC;
    ...
    startClicks = clock();              // mark the start time clicks
    quicksort(arrTemp, 0, SIZE);        // sort arrTemp by Quick Sort
    double qTime4 = (double)(clock() - startClicks) * 1000 / CLOCKS_PER_SEC;
    ...
    startClicks = clock();               // mark the start time clicks
    modifiedQuickSort(arrTemp, 0, SIZE); // sort arrTemp by Quick Sort
    double mQTime4 = (double)(clock() - startClicks) * 1000 / CLOCKS_PER_SEC;
    ...
    startClicks = clock();              // mark the start time clicks
    selectionSort(arrTemp, SIZE);       // sort arrTemp by Selection Sort
    double sTime5 = (double)(clock() - startClicks) * 1000 / CLOCKS_PER_SEC;
    ...
    startClicks = clock();              // mark the start time clicks
    insertionSort(arrTemp, SIZE);       // sort arrTemp by Insertion Sort
    double iTime5 = (double)(clock() - startClicks) * 1000 / CLOCKS_PER_SEC;
    ...
    startClicks = clock();              // mark the start time clicks
    radixSort(arrTemp, SIZE);           // sort arrTemp by Radix Sort
    double rTime5 = (double)(clock() - startClicks) * 1000 / CLOCKS_PER_SEC;
    ...
    double hTime5 = (double)(clock() - startClicks) * 1000 / CLOCKS_PER_SEC;
    ...
    startClicks = clock();              // mark the start time clicks
    quicksort(arrTemp, 0, SIZE);        // sort arrTemp by Quick Sort
    double qTime5 = (double)(clock() - startClicks) * 1000 / CLOCKS_PER_SEC;
    ...
    startClicks = clock();               // mark the start time clicks
    modifiedQuickSort(arrTemp, 0, SIZE); // sort arrTemp by Quick Sort
    double mQTime5 = (double)(clock() - startClicks) * 1000 / CLOCKS_PER_SEC;
