...
// ⚠️ update：
// 去掉了sort item function，用了additem function，效率更高；
// 用template function检验input和file input；
...
void testFilePathInput(ifstream&, string&);      // Function to verify valid file path
