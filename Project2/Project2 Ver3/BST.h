...
public:
   ...
   ------------------------------------------------------------------------*/
    ...
    // ⚠️ ⚠️ ⚠️
    void increaseConcordance(ostream & out, const DataType& item)
    {
    ...
    // ⚠️ ⚠️ ⚠️
    void updateLineNum (ostream & out, const DataType& item, const int& lineNumVal)
    {
...
private:
   ...
   ------------------------------------------------------------------------*/
    ...
    // ⚠️ ⚠️ ⚠️
    void increaseConcordanceAux(ostream& out, BinNodePointer& subtreeRoot, const DataType& item)
    {
    ...
    // ⚠️ ⚠️ ⚠️  因为要改变subtree Root下的data，所有要pass by reference
    void updateLineNumAux(ostream& out, BinNodePointer& subtreeRoot, const DataType& item, const int& NewLineNumVal)
    {
        if (item.word < subtreeRoot->data.word)
    ...
    // ⚠️ ⚠️ ⚠️
    void displayAnItemAux(ostream& out, const BinNodePointer& subtreeRoot, const DataType& item) const
    {
        if (item.word < subtreeRoot->data.word)
